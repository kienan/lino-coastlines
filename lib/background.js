...
const createNoisyTransparency = (
  ...
  tempCtx.fillStyle.addColorStop(0.2, `${paperColor}12`);
  tempCtx.fillStyle.addColorStop(0.5, `${paperColor}08`);
  tempCtx.fillStyle.addColorStop(0.8, `${paperColor}16`);
  //tempCtx.fillStyle.addColorStop(0.0, `${paperColor}08`);
  //tempCtx.fillStyle.addColorStop(0.5, `${paperColor}28`);
...
export const prepareBackgroundInputs = (canvasWidth, canvasHeight) => {
  ...
  const shouldUseSolid = random.chance(0.35) && random.pick(['bottom', 'top']);
...
export const drawBackground = (
  ...
  if (shouldUseSolid) {
    context.fillStyle = palette[shouldUseSolid];
    ...
    context.fillStyle.addColorStop(0.35, 'transparent');
    context.fillStyle.addColorStop(0.65, 'black');
    // apply transparency gradient on noise (dim top)
